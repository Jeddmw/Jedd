...
public class NBAPredictions {
    public static void main(String args[]) throws IOException {
        ...
        // Get schedule and loop through schedule and use data to calculate projected
        // points
        ...
        for (String[] game : schedule) {
            ...
            try {
                ...
                // to the league average of 107.14. Therefore, compared to the average NBA
                // defense,
                // LA concedes ~6.3% more points on road trips than the average NBA defense
                // (2016-2017 season as of 3/6/2017)
                double homeOffFactor = homePointsScored / homeAvg;
                double homeDefFactor = homePointsConceded / awayAvg; // away points scored avg is home points conceded
                                                                     // avg
                double awayOffFactor = awayPointsScored / awayAvg;
                double awayDefFactor = awayPointsConceded / homeAvg; // home points scored avg is away points conceded
                                                                     // avg

                // Multiply the average points scored home/away by each of the offensive and
                // defensive factors
                ...
                System.out.format("%-16s%-5.2f\tvs\t%-16s%-5.2f\n", (homeTeam + ":"), homePoints, (awayTeam + ":"),
                        awayPoints);
            } catch (NullPointerException ex) {
                // Could not find team name
                // System.out.println("Error when getting predictions for " + homeTeam + " vs "
                // + awayTeam);
            }
        }
    }
